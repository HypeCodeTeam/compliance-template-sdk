...
// SECTION-HNC
function getRandomHncSection(sections: string) {
...
function getRandomDetails(sections: string) {
  return {
    sectionTop: {
      [sections]: {
...
export function templateMonoPortal(themeName: string, sections: string) {
  return {
    hnc: {
