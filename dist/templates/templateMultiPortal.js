...
import { buttonVariant, buttonStyle, getRandomImageNumber, limits, getRandomBoolean, shuffleValue, includeFeature, includeBanner, includeFAQ, includePlan, categoriesArray, alignment, direction, getColorTheme, typeAssets, getAlignment, getContentPosition, } from '../utils/index';
import { getRandomPlan } from '../utils/plan';
import { getRandomSectionTop } from '../utils/sectionTop';
import { getRandomThemeLogo, getRandomThemeMode, getRandomThemeAnimationCard, getRandomThemeForm, getRandomThemeTranslation, getRandomThemeFont, } from '../utils/theme';
// SECTIONS-HNC
...
export function templateMultiPortal(themeName) {
    return {
        hnc: {
...
//# sourceMappingURL=templateMultiPortal.js.map